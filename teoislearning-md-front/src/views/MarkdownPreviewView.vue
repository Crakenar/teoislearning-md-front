  ...
  <div>
    <div>
      ...
      <div v-if="tipsActive" class="tips" >
        <h3>Tips pour ecrire un .md</h3> <br>
        <ul>
    ...
    <div class="btn-type">
      <form v-on:submit.prevent="sendMD">
        <input v-model="form.type" type="radio" name="type" id="projects" value="projects">
        <label for="projects">Projets</label>
        <input v-model="form.type" type="radio" name="type" id="experiences" value="experiences">
